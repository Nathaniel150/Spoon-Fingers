  ...
  if (stateTracker == Constants.START_SCREEN) {
    ...
    return (
      <StoryScene
        ...
        story={storyP1}
        nextLevel={Constants.LOCKLE}
      />
    ); //prop: the constant of the next component to go to
    ...
    return (
      <StoryScene
        updateState={updateState}
        story={storyP2}
        nextLevel={Constants.BATTLESHIP}
      />
    );
    ...
    return (
      <StoryScene
        updateState={updateState}
        story={storyP4}
        nextLevel={Constants.START_SCREEN}
      />
    );
  }
